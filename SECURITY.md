...
The latest release on the [releases page](https://github.com/ckgerteis/bibliograph-mcp/releases) is
...
or email christopher.gerteis@gmail.com with "bibliograph-mcp security" in the subject. Say which version, how to reproduce, and
